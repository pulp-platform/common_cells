...
| [`clk_div`](src/deprecated/clk_div.sv)                             | Clock divider with integer divisor                                                    | *deprecated* | `clk_int_div` |
| [`clock_divider`](src/deprecated/clock_divider.sv)                 | Clock divider with configuration registers                                            | *deprecated* | `clk_int_div` |
| [`clock_divider_counter`](src/deprecated/clock_divider_counter.sv) | Clock divider using a counter                                                         | *deprecated* | `clk_int_div` |
...
| [`pulp_sync`](src/deprecated/pulp_sync.sv)                            | Serial line synchronizer                                                                      | *deprecated* | `sync`        |
| [`pulp_sync_wedge`](src/deprecated/pulp_sync_wedge.sv)                | Serial line synchronizer with edge detector                                                   | *deprecated* | `sync_wedge`  |
...
| [`generic_LFSR_8bit`](src/deprecated/generic_LFSR_8bit.sv) | 8-bit linear feedback shift register (LFSR)                       | *deprecated* | `lfsr_8bit`   |
...
| [`find_first_one`](src/deprecated/find_first_one.sv)           | Leading-one finder / leading-zero counter                                                                 | *deprecated* | `lzc`         |
...
| [`rrarbiter`](src/deprecated/rrarbiter.sv)                     | Round-robin arbiter for req/ack interface with look-ahead                                                 | *deprecated* | `rr_arb_tree` |
| [`prioarbiter`](src/deprecated/prioarbiter.sv)                 | Priority arbiter arbiter for req/ack interface with look-ahead                                            | *deprecated* | `rr_arb_tree` |
...
| [`fifo`](src/deprecated/fifo_v1.sv)                              | FIFO register with upper threshold                                          | *deprecated* | `fifo_v3`                                                                                       |
...
| [`generic_fifo_adv`](src/deprecated/generic_fifo_adv.sv)         | FIFO register without thresholds                                            | *deprecated* | `fifo_v3`                                                                                       |
