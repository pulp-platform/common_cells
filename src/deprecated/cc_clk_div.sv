...
module cc_clk_div #(
  ...
  if (SHOW_WARNING) begin : gen_elab_warning
    $warning(
       ...
       "configurable cc_clk_int_div module which always generates 50%%  ",
       "duty cycle clock. If you don't need at runtime configuration ",
       "support, you can instantiate cc_clk_int_div as follows to       ",
       ...
       "optional cc_clk_div parameter SHOW_WARNING to 1'b0.");
  end
