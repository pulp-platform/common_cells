...
// -----------------------------------------------------------------------------
// File : cc_clk_int_div.sv Author : Manuel Eggimann <meggimann@iis.ee.ethz.ch>
// Created : 17.03.2022
// -----------------------------------------------------------------------------
// Description :
//
...
// changes are handshaked and during the transitioning phase between cc_clk_div
// value changes, the output clock is gated to prevent clock glitches and no
// other cc_clk_div change request is accepted. clk_o remains gated for at most
