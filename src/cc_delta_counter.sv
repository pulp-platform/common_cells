...
// Up/down counter with variable delta. Synchronous clear has priority over
// load, which has priority over counting. In transient mode, overflow_o is the
// extra arithmetic bit. In sticky mode, overflow_o records the first overflow
// or underflow until reset, clear, or load.
